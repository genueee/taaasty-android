...
public abstract class SystemUiHider {
     ...
     */
    public static SystemUiHider getInstance(ActivityBase activity, View anchorView, int flags) {
    ...
    protected SystemUiHider(ActivityBase activity, View anchorView, int flags) {
        mActivity = activity;
