...
package ru.taaasty.recyclerview.util;
 ...
 * list
 * such that it can be bound to a {@link ru.taaasty.recyclerview.RecyclerView.Adapter
...
public class SortedList<T> {
    ...
    public static abstract class Callback<T2> implements Comparator<T2> {
         ...
         * <p>
         * For example, if you are using SortedList with a {@link ru.taaasty.recyclerview.RecyclerView.Adapter
