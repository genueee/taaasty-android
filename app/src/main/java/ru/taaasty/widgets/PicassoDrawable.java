...
public final class PicassoDrawable extends BitmapDrawable {
   ...
   * placeholder image.
   */
  public static void setPlaceholder(ImageView target, int placeholderResId, Drawable placeholderDrawable) {
  ...
  public PicassoDrawable(Context context, Bitmap bitmap, Drawable placeholder,
                         Picasso.LoadedFrom loadedFrom, boolean noFade, boolean debugging) {
